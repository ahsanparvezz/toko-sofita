...
from main.views import show_main, edit_product, delete_product, create_product, show_product, show_xml, show_json, show_xml_by_id, show_json_by_id, register, login_user, logout_user
